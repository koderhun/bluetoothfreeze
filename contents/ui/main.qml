...
PlasmoidItem {
    ...
    readonly property string playIcon: "media-playback-start"
    readonly property string stopIcon: "media-playback-stop"
    ...
    Plasma5Support.DataSource {
        ...
        onNewData: function(source, data) {
          console.log("onNewData: " + source)
          disconnectSource(source);
          if (Plasmoid.configuration.minutes !== minutes) {
            console.log("Configuration settings have changed. Stopping the script.");
            // execStop();
          }
        }
    }
